---
description: Test patterns and TDD workflow for caml
paths:
  - "spec/**/*_spec.rb"
---
...
- RSpec under `spec/`. Run with `bundle exec rspec`.
- No fixtures or shared setup yet — each spec arranges its own state.
- The CLI shells out via `system`; stub or fake the shell call rather than running real commands in tests.
