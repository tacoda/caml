...
Implement a change in **caml**: $ARGUMENTS
...
### Phase 6: Refactor
15. Spawn the **refactor-changes agent** on the diff. Present findings as a numbered list and ask which to address.
16. Run `/pre-commit`, commit, push.

### Phase 7: Done
17. Confirm everything is green and ask for any follow-up.
